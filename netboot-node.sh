...
tftpIp=$(hostname -I | grep -Eo '([0-9]*\.){3}[0-9]*' | xargs | print '{print $1}') # trouble if ipv6 is active, so only get IPv4, see: https://danielchg.github.io/posts/dnsmasq-for-dualstack/
